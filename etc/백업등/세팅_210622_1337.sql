...
Insert into MEMBER (M_ID,M_PASS,M_BIRTH,M_NAME,M_ADDR,M_GENDER,M_EMAIL,M_PHONE,M_TF) values ('에버랜드','1234','19760403','정금용','경기 용인시 처인구 에버랜드로 199 (전대리, 삼성에버랜드) 에버랜드','서비스업','2,472명','3,725억원','0');
...
Insert into MEMBER (M_ID,M_PASS,M_BIRTH,M_NAME,M_ADDR,M_GENDER,M_EMAIL,M_PHONE,M_TF) values ('버거킹','1234','20121121','문영주','서울 종로구 삼봉로 71 (수송동, G타워) G타워 2F','음식료·외식·프랜차이즈','900명','2,730억원','0');
Insert into MEMBER (M_ID,M_PASS,M_BIRTH,M_NAME,M_ADDR,M_GENDER,M_EMAIL,M_PHONE,M_TF) values ('하나은행','1234','19670130','함영주','서울 서초구 남부순환로 2351 (서초동, 국제방송교류재단) 2층 KEB하나은행 방배남출장소','은행·금융','13,000명','6조 3천억원','0');
...
Insert into MEMBER (M_ID,M_PASS,M_BIRTH,M_NAME,M_ADDR,M_GENDER,M_EMAIL,M_PHONE,M_TF) values ('트리플제이','1234','20201218','주성돈','서울 영등포구 여의나루로 67 (여의도동, 신송빌딩) 1205호-이에스19호','컨설팅·연구·조사','30명','8억 3,530만원','0');
...
Insert into MEMBER (M_ID,M_PASS,M_BIRTH,M_NAME,M_ADDR,M_GENDER,M_EMAIL,M_PHONE,M_TF) values ('이안한방병원','1234','20010408','김동호','경기 오산시 대원로 23 (원동) 이안한방병원','의료','43명','15억 1,150만원','0');
...
Insert into RESUME (R_NUM,M_ID,R_TITLE,R_PIC,R_FILE,R_DATE) values (2,'mh777','나의 이력서','fileSave/mypic2.jpg','fileSave/포트폴리오.show',to_date('21/05/02','RR/MM/DD'));
...
Insert into RESUME (R_NUM,M_ID,R_TITLE,R_PIC,R_FILE,R_DATE) values (4,'seojun','이력서','fileSave/mypic4.jpg','fileSave/포트폴리오.show',to_date('21/04/22','RR/MM/DD'));
...
Insert into RESUME (R_NUM,M_ID,R_TITLE,R_PIC,R_FILE,R_DATE) values (6,'dodo77','나의 이력서','fileSave/mypic4.jpg','fileSave/포트폴리오.show',to_date('21/04/22','RR/MM/DD'));
Insert into RESUME (R_NUM,M_ID,R_TITLE,R_PIC,R_FILE,R_DATE) values (7,'sioo','나의 이력서','fileSave/mypic4.jpg','fileSave/포트폴리오.show',to_date('21/04/22','RR/MM/DD'));
Insert into RESUME (R_NUM,M_ID,R_TITLE,R_PIC,R_FILE,R_DATE) values (8,'joo99','나의 이력서','fileSave/mypic4.jpg','fileSave/포트폴리오.show',to_date('21/04/22','RR/MM/DD'));
Insert into RESUME (R_NUM,M_ID,R_TITLE,R_PIC,R_FILE,R_DATE) values (9,'hajoon','나의 이력서','fileSave/mypic4.jpg','fileSave/포트폴리오.show',to_date('21/04/22','RR/MM/DD'));
Insert into RESUME (R_NUM,M_ID,R_TITLE,R_PIC,R_FILE,R_DATE) values (10,'jiho','나의 이력서','fileSave/mypic4.jpg','fileSave/포트폴리오.show',to_date('21/04/22','RR/MM/DD'));
Insert into RESUME (R_NUM,M_ID,R_TITLE,R_PIC,R_FILE,R_DATE) values (11,'hoo999','나의 이력서','fileSave/mypic4.jpg','fileSave/포트폴리오.show',to_date('21/04/22','RR/MM/DD'));
Insert into RESUME (R_NUM,M_ID,R_TITLE,R_PIC,R_FILE,R_DATE) values (12,'junjun','나의 이력서','fileSave/mypic4.jpg','fileSave/포트폴리오.show',to_date('21/04/22','RR/MM/DD'));
Insert into RESUME (R_NUM,M_ID,R_TITLE,R_PIC,R_FILE,R_DATE) values (13,'iin110','나의 이력서','fileSave/mypic4.jpg','fileSave/포트폴리오.show',to_date('21/04/22','RR/MM/DD'));
...
Insert into RE_SELF_REL (R_NUM,SI_NUM,SI_ORDER) values (1,4,null);
...
Insert into RE_SELF_REL (R_NUM,SI_NUM,SI_ORDER) values (2,11,null);
...
Insert into RE_SELF_REL (R_NUM,SI_NUM,SI_ORDER) values (2,14,null);
...
Insert into APPLY (M_ID,RC_NUM,R_NUM,A_DATE,AP_CNT) values ('mh777',1001,2,to_date('21/06/05','RR/MM/DD'),1);
