			...
			<table id="table_apply">
				...
				<c:forEach var="allist" items="${list}">
					<tr>
						...
						<td><input type="button" value="보기" class="btn"
									onclick="window.open('${pageContext.request.contextPath}/hireApply.do?rc_num=${allist.rc_num}','name','resizable=no width=1050 height=1200');return false">
